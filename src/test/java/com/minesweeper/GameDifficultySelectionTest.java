...
public class GameDifficultySelectionTest {
    ...
    void validSelection_AppliesCorrectBoardSizeAndMineCount() {
        ...
        // Easy
        Game easyGame = new Game("Easy", inputProvider);
        ...
        // Intermediate
        Game intermediateGame = new Game("Intermediate", inputProvider);
        ...
        // Expert
        Game expertGame = new Game("Expert", inputProvider);
    ...
    void invalidSelection_DefaultsToPredefinedDifficulty() {
        ...
        Game invalidGame = new Game("Invalid", inputProvider);
